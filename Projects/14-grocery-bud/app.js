...
function clearItems() {
  ...
  //   removing the container which contains clear items button
  container.classList.remove("show-container");
...
function setbackToDefault(value) {
  grocery.value = "";
  editFlag = false;
  editID = "";
...
function createListItems(id, value) {
  ...
  // add class
  elememt.classList.add("grocery-item");

  // add id
  const attr = document.createAttribute("data-id");
  attr.value = id;
  elememt.setAttributeNode(attr);
  elememt.innerHTML = `<p class="title">${value}</p>
